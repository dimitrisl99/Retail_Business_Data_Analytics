...
Each sheet is exported as CSV and imported into the PostgreSQL database.
...
-- Load data from the exported Google Sheets CSV
...
![alt text](<images/previous day 1.png>)


![alt text](<images/previous day 2.png>)
...
![alt text](<images/does it worth it.png>)
...
![alt text](<images/typical customer.png>)
